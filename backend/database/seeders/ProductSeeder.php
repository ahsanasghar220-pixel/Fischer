    ...
    private function seedFastElectricWaterHeaters(Brand $brand): void
    {
        ...
        $products = [
            [
                ...
                'image' => '/images/products/fast-electric-water-heaters/ffew-f30.jpeg',
                'stock_status' => 'in_stock',
            ],
            [
                ...
                'image' => '/images/products/fast-electric-water-heaters/ffew-f40.jpeg',
                'stock_status' => 'in_stock',
                'average_rating' => 4.5,
                'is_featured' => true,
            ],
            [
                ...
                'image' => '/images/products/fast-electric-water-heaters/ffew-f50.jpg',
                'stock_status' => 'in_stock',
            ],
            [
                ...
                'image' => '/images/products/fast-electric-water-heaters/ffew-f60.jpg',
                'stock_status' => 'in_stock',
            ],
            [
                ...
                'image' => '/images/products/fast-electric-water-heaters/ffew-f80.jpg',
                'stock_status' => 'in_stock',
                'is_bestseller' => true,
            ],
            [
            ...
            [
                ...
                'image' => '/images/products/fast-electric-water-heaters/few-ecowatt.jpg',
                'stock_status' => 'in_stock',
                'is_featured' => true,
                'average_rating' => 5.0,
            ],
    ...
    private function seedInstantElectricWaterHeaters(Brand $brand): void
    {
        ...
        $products = [
            [
                ...
                'image' => '/images/products/instant-electric-water-heaters/fics-10l.jpg',
                'stock_status' => 'in_stock',
                'is_featured' => true,
            ],
            [
    ...
    private function seedOvenToasters(Brand $brand): void
    {
        ...
        $products = [
            [
                ...
                'image' => '/images/products/oven-toasters/fot-1901d.jpg',
                'stock_status' => 'in_stock',
                'is_new' => true,
                'is_featured' => true,
            ],
    ...
    private function seedAirFryers(Brand $brand): void
    {
        ...
        $products = [
            [
                ...
                'image' => '/images/products/air-fryers/faf-401wd.jpg',
                'stock_status' => 'in_stock',
                'is_new' => true,
            ],
            [
                ...
                'image' => '/images/products/air-fryers/faf-601wd.jpg',
                'stock_status' => 'in_stock',
                'is_featured' => true,
                'is_new' => true,
            ],
            [
                ...
                'image' => '/images/products/air-fryers/faf-801wd.jpg',
                'stock_status' => 'in_stock',
                'is_new' => true,
                'is_bestseller' => true,
            ],
