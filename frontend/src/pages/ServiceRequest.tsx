    ...
    return (
      <div className="min-h-screen bg-dark-50 flex items-center justify-center py-12 px-4">
        <div className="max-w-md w-full bg-white rounded-xl shadow-sm p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-dark-900 mb-2">Request Submitted!</h2>
          ...
          <div className="bg-dark-50 rounded-lg p-4 mb-6">
            <p className="text-sm text-dark-500">Your Ticket Number</p>
            <p className="text-2xl font-bold text-dark-900">{ticketNumber}</p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-dark-300">Schedule a service for your Fischer appliance</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {step === 1 && (
              <div className="bg-white rounded-xl shadow-sm p-6">
                <h2 className="text-xl font-semibold text-dark-900 mb-6">Select Service Type</h2>
                  ...
                  {serviceTypes.map((type) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          <h3 className="font-medium text-dark-900">{type.label}</h3>
            ...
            {step === 2 && (
              <div className="bg-white rounded-xl shadow-sm p-6">
                <h2 className="text-xl font-semibold text-dark-900 mb-6">Product Details</h2>
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-dark-700 mb-1">Product Category *</label>
                    <select
                  ...
                  <div>
                    <label className="block text-sm font-medium text-dark-700 mb-1">Model Number</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-dark-700 mb-1">Serial Number</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-dark-700 mb-1">Issue Description *</label>
                    <textarea
            ...
            {step === 4 && (
              <div className="bg-white rounded-xl shadow-sm p-6">
                <h2 className="text-xl font-semibold text-dark-900 mb-6">Schedule Service</h2>
                <div className="space-y-4">
                  <div>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-dark-700 mb-1">Preferred Time</label>
                    <select
                ...
                <div className="mt-6 p-4 bg-dark-50 rounded-lg">
                  <h3 className="font-semibold text-dark-900 mb-3">Request Summary</h3>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-dark-500">Service Type:</span>
                      <span className="text-dark-900 capitalize">{formData.service_type.replace('_', ' ')}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-dark-500">Product:</span>
                      <span className="text-dark-900">{formData.product_category}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-dark-500">City:</span>
                      <span className="text-dark-900">{formData.city}</span>
                    </div>
                  </div>
                </div>

                <div className="mt-6 flex justify-between">
                  <button type="button" onClick={() => setStep(3)} className="btn btn-dark-outline px-8">
                    Back
                  </button>
                  <button
                    type="submit"
