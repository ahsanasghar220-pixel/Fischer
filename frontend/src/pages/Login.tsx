      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link to="/" className="inline-block">
            <img src="/images/logo/Fischer-electronics-logo-black.svg" alt="Fischer" width={784} height={465} className="h-20 w-auto mx-auto dark:hidden" />
            <img src="/images/logo/Fischer-electronics-logo-white.svg" alt="Fischer" width={784} height={465} className="h-20 w-auto mx-auto hidden dark:block" />
          </Link>
