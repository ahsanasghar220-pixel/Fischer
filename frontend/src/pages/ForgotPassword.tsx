      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link to="/" className="inline-block">
            <img src="/images/logo-dark.webp" alt="Fischer" width={792} height={436} className="h-12 w-auto mx-auto dark:hidden" />
            <img src="/images/logo-light.webp" alt="Fischer" width={792} height={436} className="h-12 w-auto mx-auto hidden dark:block" />
          </Link>
