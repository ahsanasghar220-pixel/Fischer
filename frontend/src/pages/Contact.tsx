...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-dark-50 dark:bg-dark-900 transition-colors">
      {/* Header */}
      <div className="bg-dark-900 dark:bg-dark-950 text-white py-16 transition-colors">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-dark-800 rounded-xl shadow-sm p-6 space-y-6 transition-colors">
              <h2 className="text-xl font-semibold text-dark-900 dark:text-white">Get in Touch</h2>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-medium text-dark-900 dark:text-white">Address</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-medium text-dark-900 dark:text-white">Phone</h3>
                  <p className="text-dark-500 dark:text-dark-400 text-sm mt-1">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-medium text-dark-900 dark:text-white">Email</h3>
                  <p className="text-dark-500 dark:text-dark-400 text-sm mt-1">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-medium text-dark-900 dark:text-white">Business Hours</h3>
                  <p className="text-dark-500 dark:text-dark-400 text-sm mt-1">
              ...
              <div className="pt-4 border-t border-dark-200 dark:border-dark-700">
                ...
                <div className="flex gap-3">
                  <a
                    href="https://facebook.com/fischerPK"
                    target="_blank"
                  ...
                  <a
                    href="https://instagram.com/fischerPK"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 bg-dark-100 dark:bg-dark-700 rounded-full flex items-center justify-center text-dark-600 dark:text-dark-400 hover:bg-primary-100 dark:hover:bg-primary-900/30 hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
                  >
                  ...
                  <a
                    href="https://youtube.com/fischerPK"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 bg-dark-100 dark:bg-dark-700 rounded-full flex items-center justify-center text-dark-600 dark:text-dark-400 hover:bg-primary-100 dark:hover:bg-primary-900/30 hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
                  >
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-dark-200 dark:border-dark-600 rounded-lg bg-white dark:bg-dark-700 text-dark-900 dark:text-white placeholder-dark-400 dark:placeholder-dark-500 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 transition-colors"
                      required
                    />
                  </div>
                  <div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 border border-dark-200 dark:border-dark-600 rounded-lg bg-white dark:bg-dark-700 text-dark-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 transition-colors"
                      required
                    >
