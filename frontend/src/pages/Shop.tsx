        ...
        <div className="flex gap-8">
          ...
          >
            <div className="sticky top-4 space-y-6">
              {/* Categories */}
              <div
                className="bg-white dark:bg-dark-800 rounded-xl p-4 shadow-sm hover:scale-[1.01] transition-transform"
              >
          ...
          <div className="flex-1">
            ...
            {/* Mobile Filters - Full-width drawer with slide animation */}
            <AnimatePresence>
              {showFilters && (
                <div className="lg:hidden fixed inset-0 bg-black/50 z-50">
                  ...
                  >
                    ...
                    <div className="sticky bottom-0 p-4 border-t border-dark-200 dark:border-dark-700 bg-white dark:bg-dark-800">
                      ...
                      >
                        Show Results{productsData ? ` (${productsData.meta.total})` : ''}
                      </button>
                    </div>
                  </motion.div>
                </div>
