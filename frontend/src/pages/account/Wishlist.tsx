    ...
    <div className="space-y-6">
      <div className="bg-white rounded-xl shadow-sm">
        ...
        <div className="p-4 border-b flex items-center justify-between">
          <div>
            <h2 className="text-xl font-semibold text-dark-900">My Wishlist</h2>
        ...
        {items && items.length > 0 ? (
              ...
              <div key={item.id} className="p-4">
                <div className="flex gap-4">
                  ...
                  <Link
                    ...
                    className="w-24 h-24 bg-dark-100 rounded-lg overflow-hidden flex-shrink-0"
                  >
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <button
                      ...
                      className="btn btn-dark-outline btn-sm flex items-center gap-1 text-red-600 border-red-200 hover:bg-red-50"
                    >
          ...
          <div className="p-12 text-center">
            <HeartIcon className="w-16 h-16 mx-auto text-dark-300 mb-4" />
