  ...
  return (
    ...
    >
      ...
      <div ref={videoContainerRef} className={`relative ${!isEven ? 'order-2' : ''}`}>
        <div className="relative aspect-[4/3] sm:aspect-video rounded-lg sm:rounded-xl overflow-hidden shadow-md sm:shadow-xl bg-dark-100 dark:bg-dark-900">
        ...
        <div className="space-y-2 sm:space-y-4 md:space-y-6">
          ...
          <div className="pt-0 sm:pt-2">
            <Link
              ...
              className="inline-flex items-center gap-1 sm:gap-2 px-4 py-1 sm:px-5 sm:py-2.5 md:px-6 md:py-3 rounded sm:rounded-xl
                       bg-primary-500 dark:bg-primary-600
                       text-white text-[10px] leading-none sm:text-sm md:text-base font-semibold
            ...
            >
              ...
              <ArrowRightIcon className="w-2 h-2 sm:w-4 sm:h-4" />
            </Link>
          </div>
        </div>
      </div>
  ...
  return (
    <section className="section bg-white dark:bg-dark-900">
      <div className="container-xl">
        ...
        <div className="space-y-8 sm:space-y-12 md:space-y-16 lg:space-y-20 overflow-hidden max-w-5xl mx-auto">
