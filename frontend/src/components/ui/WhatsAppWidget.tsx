    ...
    <>
      ...
      >
        <button
          ...
          className="group relative bg-[#25D366] hover:bg-[#128C7E] text-white rounded-full p-4 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-110"
          ...
          <AnimatePresence>
            {isOpen && (
              <motion.div
                ...
                className="absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-dark-900 dark:bg-dark-800 text-white px-4 py-2 rounded-lg shadow-xl whitespace-nowrap"
              >
                <div className="text-sm font-medium">Chat with us on WhatsApp</div>
                <div className="text-xs text-dark-400 mt-0.5">We're here to help!</div>

                {/* Arrow */}
                <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-full">
                  <div className="border-8 border-transparent border-l-dark-900 dark:border-l-dark-800" />
                </div>
              </motion.div>
            )}
          </AnimatePresence>
