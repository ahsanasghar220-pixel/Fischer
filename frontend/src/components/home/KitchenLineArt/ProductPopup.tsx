...
@keyframes pulse-glow {
  0%, 100% { box-shadow: 0 20px 40px rgba(0,0,0,0.2), 0 0 20px rgba(29,125,215,0.15); }
  50% { box-shadow: 0 20px 50px rgba(0,0,0,0.25), 0 0 30px rgba(29,125,215,0.25); }
}
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle at 50% 50%, rgba(29,125,215,0.08) 0%, rgba(0,0,0,0.3) 100%)',
