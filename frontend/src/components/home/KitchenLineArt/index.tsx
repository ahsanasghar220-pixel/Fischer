        ...
        <>
          <motion.div
            ...
            style={{
              x: blob1X,
              y: blob1Y,
              background: 'radial-gradient(circle, rgba(29,125,215,0.4) 0%, transparent 70%)',
              top: '10%',
              left: '10%'
            }}
            animate={{
          ...
          <motion.div
            ...
            style={{
              x: glowX,
              y: glowY,
              background: 'radial-gradient(circle, rgba(29,125,215,0.15) 0%, transparent 70%)',
              filter: 'blur(60px)',
          ...
          <motion.div
            ...
            style={{
              background: 'radial-gradient(ellipse at center, rgba(29,125,215,0.05) 0%, transparent 60%)'
            }}
            animate={{
              background: [
                'radial-gradient(ellipse at 20% 30%, rgba(29,125,215,0.05) 0%, transparent 60%)',
          ...
          {[...Array(15)].map((_, i) => (
            <motion.div
              ...
              style={{
                ...
                top: `${Math.random() * 100}%`,
                background: i % 2 === 0 ? 'rgba(29,125,215,0.2)' : 'rgba(59,130,246,0.2)',
      ...
      <div ref={containerRef} className="container mx-auto px-4 relative">
        ...
        >
          ...
          <motion.div
            ...
            style={{
              background: 'radial-gradient(ellipse at center, rgba(29,125,215,0.15) 0%, transparent 70%)',
              filter: 'blur(40px)'
            }}
            animate={{
              scale: [1, 1.05, 1],
          ...
          <motion.p className="inline-flex items-center gap-2 text-dark-400 dark:text-dark-500 text-sm">
            <motion.span
              ...
              animate={{
                ...
                opacity: [0.5, 1, 0.5],
                boxShadow: [
                  '0 0 0 0 rgba(29,125,215,0.4)',
                  '0 0 0 8px rgba(29,125,215,0)',
                  '0 0 0 0 rgba(29,125,215,0.4)'
                ]
              }}
